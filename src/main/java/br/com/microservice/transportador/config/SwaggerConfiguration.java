package br.com.microservice.transportador.config;
...
public class SwaggerConfiguration {
	...
	public Docket forumApi() {
		return new Docket(DocumentationType.SWAGGER_2)
				.select()
				.apis(RequestHandlerSelectors.basePackage("br.com.microservice.transportador.controller"))
	...
	private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
        	.title("Spring Microservice - Transportador API")
            ...
            .licenseUrl("https://github.com/mupezzuol/spring-microservice-transportador")
            .version("1.0.0")
            .build();
    }
